...
import * as Struct from "./data/Struct.bs.mjs";
import * as Message from "./data/Message.bs.mjs";
import * as Subject from "./Subject.bs.mjs";
...
var NotConnectBackend = /* @__PURE__ */Caml_exceptions.create("Session.NotConnectBackend");

var OneshotTimeout = /* @__PURE__ */Caml_exceptions.create("Session.OneshotTimeout");

var ResponseError = /* @__PURE__ */Caml_exceptions.create("Session.ResponseError");

function setResponse(subject, v) {
  subject.set(v, Message.getResponseRequestId(v));
}

function setEmptyResponse(subject, v) {
  subject.set(v, Message.getEmptyResponseRequestId(v));
}
...
function make($$WebSocket, $staropt$star) {
  ...
  var unitSubject = Subject.make(undefined);
  var websocketErrorSubject = Subject.make(undefined);
  var jsonErrorSubject = Subject.make(undefined);
  var loginSubject = Subject.make(undefined);
  var setClientIDSubject = Subject.make(undefined);
  var requestForwardSubject = Subject.make(undefined);
  var receiveForwardSubject = Subject.make(undefined);
  var setTokenSubject = Subject.make(undefined);
  var getDanmakuSubject = Subject.make(undefined);
  var stopDanmakuSubject = Subject.make(undefined);
  var getWatchingListSubject = Subject.make(undefined);
  var getBillboardSubject = Subject.make(undefined);
  var getSummarySubject = Subject.make(undefined);
  var getLuckListSubject = Subject.make(undefined);
  var getPlaybackSubject = Subject.make(undefined);
  var getAllGiftListSubject = Subject.make(undefined);
  var getWalletBalanceSubject = Subject.make(undefined);
  var getUserLiveInfoSubject = Subject.make(undefined);
  var getAllLiveListSubject = Subject.make(undefined);
  var getLiveDataSubject = Subject.make(undefined);
  var getGiftListSubject = Subject.make(undefined);
  var getUserInfoSubject = Subject.make(undefined);
  var getLiveCutInfoSubject = Subject.make(undefined);
  var getManagerListSubject = Subject.make(undefined);
  var addManagerSubject = Subject.make(undefined);
  var deleteManagerSubject = Subject.make(undefined);
  var getAllKickHistorySubject = Subject.make(undefined);
  var managerKickSubject = Subject.make(undefined);
  var authorKickSubject = Subject.make(undefined);
  var getMedalDetailSubject = Subject.make(undefined);
  var getMedalListSubject = Subject.make(undefined);
  var getMedalRankListSubject = Subject.make(undefined);
  var getUserMedalSubject = Subject.make(undefined);
  var wearMedalSubject = Subject.make(undefined);
  var cancelWearMedalSubject = Subject.make(undefined);
  var checkLiveAuthSubject = Subject.make(undefined);
  var getLiveTypeListSubject = Subject.make(undefined);
  var getPushConfigSubject = Subject.make(undefined);
  var getLiveStatusSubject = Subject.make(undefined);
  var getTranscodeInfoSubject = Subject.make(undefined);
  var startLiveSubject = Subject.make(undefined);
  var stopLiveSubject = Subject.make(undefined);
  var changeTitleAndCoverSubject = Subject.make(undefined);
  var getLiveCutStatusSubject = Subject.make(undefined);
  var setLiveCutStatusSubject = Subject.make(undefined);
  var commentSubject = Subject.make(undefined);
  var likeSubject = Subject.make(undefined);
  var enterRoomSubject = Subject.make(undefined);
  var followAuthorSubject = Subject.make(undefined);
  var throwBananaSubject = Subject.make(undefined);
  var giftSubject = Subject.make(undefined);
  var richTextSubject = Subject.make(undefined);
  var joinClubSubject = Subject.make(undefined);
  var shareLiveSubject = Subject.make(undefined);
  var danmakuStopSubject = Subject.make(undefined);
  var bananaCountSubject = Subject.make(undefined);
  var displayInfoSubject = Subject.make(undefined);
  var topUsersSubject = Subject.make(undefined);
  var recentCommentsSubject = Subject.make(undefined);
  var redpackListSubject = Subject.make(undefined);
  var chatCallSubject = Subject.make(undefined);
  var chatAcceptSubject = Subject.make(undefined);
  var chatReadySubject = Subject.make(undefined);
  var chatEndSubject = Subject.make(undefined);
  var danmakuStopErrorStopSubject = Subject.make(undefined);
  var kickedOutSubject = Subject.make(undefined);
  var violationAlertSubject = Subject.make(undefined);
  var managerStateSubject = Subject.make(undefined);
  var uuidDict = {};
  ...
  var connect = function () {
    ...
    $$WebSocket.addOpenListener(w, (function (param) {
            heartbeatInterval.contents = Caml_option.some(setInterval((function () {
                        $$WebSocket.send(w, Message.heartbeat);
                      }), 5000));
    ...
    $$WebSocket.addMessageListener(w, (function (param) {
            var data = param.data;
            var response = Struct.parseResponse(data);
            if (response.TAG !== "Ok") {
            ...
            switch (response$1.TAG) {
              ...
              case 100 :
                  var v = response$1._0;
                  return getDanmakuSubject.set(v, Message.getOptionalResponseRequestId(v));
              case 101 :
  ...
  var sendRequest = function (data, ws) {
    var d = Struct.serializeRequest(data);
    if (d.TAG === "Ok") {
  ...
  var request = function (request$1, data, requestID) {
    ...
    switch (request$1) {
      case "login" :
          return sendRequest({
                      TAG: 2,
                      _0: Message.makeMessage(data, requestID)
                    }, w$1);
      case "setClientID" :
          return sendRequest({
                      TAG: 3,
      ...
      case "getAllGiftList" :
          return sendRequest({
                      TAG: 107,
                      _0: Message.makeEmptyMessage(requestID)
                    }, w$1);
      case "getWalletBalance" :
          return sendRequest({
                      TAG: 108,
  ...
  var oneshot = function (request, data, requestIDPrefix, timeout) {
    ...
    return new Promise((function (resolve, reject) {
                  ...
                  var handleEmptyMessage = function (subject, constructor) {
                    sendRequest(constructor(Message.makeEmptyMessage(requestID)), w$1);
                  ...
                  var handleMessage = function (subject, constructor) {
                    sendRequest(constructor(Message.makeMessage(data, requestID)), w$1);
                    unsubscribe.contents = subject.oneshot((function (value, param) {
                            clearTimeout(timeout$1);
                            deleteUuid(undefined);
                            if (value.TAG === "Ok") {
